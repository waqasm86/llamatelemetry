...
llamatelemetry.init(
    ...
    service_version: str = "2.0.0", # OTel service version attribute.
...
cfg = auto_configure(
    binary_version: str = "2.0.0",  # CUDA binary version to bootstrap.
...
| `LLAMATELEMETRY_BINARY_VERSION` | `"2.0.0"` | CUDA binary version |
